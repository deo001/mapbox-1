...
extension City on Point {
  static var darEsSalaam = Point(coordinates: Position(-6.82292, 39.26970));
  static var mbeya = Point(coordinates: Position(-8.9036, 33.4608));
  static var rukwa = Point(coordinates: Position(-7.9666, 31.2166));
}
